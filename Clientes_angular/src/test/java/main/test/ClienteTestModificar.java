...
@DataJpaTest
public class ClienteTestModificar {
	...
	@Test
	public void cuandoModificaNombresEntoncesRetornaModificado() {
		this.dao.save(new Clientes("1111111-1", "Cesar 1", "Cofre 1", "example@example.cl", "+561111111"));
		Clientes cesar1 = this.dao.findById("1111111-1").get();
		assertNotNull(cesar1);
		assertTrue("ES " + cesar1.getNombres() + " PERO DEBERÍA SER Cesar 1", cesar1.getNombres().equals("Cesar 1"));
	}
}
